...
import 'package:gentelella_flutter_datatable/api/users_list_api.dart';
import 'package:gentelella_flutter_datatable/models/users.dart';
import 'dart:async';
import 'dart:convert';
...
class _HomePageState extends State<HomePage> {
  ...
  initState() {
    ...
    _getFromApi();
    _activeUsers = [];
    timer = Timer.periodic(Duration(seconds: 10), (Timer t) => _getFromApi());
